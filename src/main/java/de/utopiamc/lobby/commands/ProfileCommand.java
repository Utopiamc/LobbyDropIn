...
public class ProfileCommand {
    ...
    public static void openInv(Player p){
        ...
        ItemStack wand = new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 9).setDisplayName("§9").build();
        ...
        inv.setItem(13, new ItemBuilder(Material.SAPLING).setDisplayName(LINK).addLineLore("§7Hier kannst du deinen").addLineLore("§7Minecraft Konto verknüpfen mit").addLineLore("§7» Discord").addLineLore("§7» Forum/Webseite").addLineLore("").addLineLore("§e§oKlick").build());
        inv.setItem(21, new ItemBuilder(Material.PAPER).setDisplayName(STATS).build());
        inv.setItem(22, new ItemBuilder(Material.REDSTONE_COMPARATOR).setDisplayName(SETTINGS).build());
